...
<head>
    ...
    <title>Choosen One Mart - Fresh Groceries</title>
...
<body>
    ...
    <!-- Hero Section -->
    <div class="bg-com text-white py-5">
        <div class="container text-center py-4">
            <h1 class="display-4 fw-bold">Fresh Groceries Delivered</h1>
            <p class="lead">Quality products at affordable prices</p>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="btn-group" role="group">
                    ...
                    <a href="index.php?category=Fruits" class="btn btn-outline-secondary">Fruits</a>
                    <a href="index.php?category=Vegetables" class="btn btn-outline-secondary">Vegetables</a>
                    <a href="index.php?category=Dairy" class="btn btn-outline-secondary">Dairy</a>
                    <a href="index.php?category=Meat" class="btn btn-outline-secondary">Meat</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card product-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="fw-bold text-com">$<?php echo number_format($product['price'], 2); ?></p>
                        </div>
                        <div class="card-footer bg-white border-0">
                            <?php if (isLoggedIn()): ?>
                                <form action="add_to_cart.php" method="post" class="d-grid">
                                    <input type="hidden" name="product_id" value="<?php echo $product['id']; ?>">
                                    <button type="submit" class="btn btn-com">
                                        <i class="bi bi-cart-plus"></i> Add to Cart
                                    </button>
                                </form>
                            <?php else: ?>
                                <a href="login.php" class="btn btn-com w-100">
